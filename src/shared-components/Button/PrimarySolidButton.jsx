const PrimarySolidButton = ({text, type, onClick,  disabled, action}) => {
    ...
    return (
        ...
        <button
            ...
            classNameName="group relative w-full flex 
            ...
            {action
             ...
             :
                <span classNameName="absolute left-0 inset-y-0 flex items-center pl-3">
                        ...
                        <svg classNameName="h-5 w-5 text-indigo-500 group-hover:text-indigo-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
